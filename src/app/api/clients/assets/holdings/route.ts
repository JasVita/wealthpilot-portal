// curl -s 'http://localhost:3000/api/clients/assets/holdings?client_id=32'
//  curl -s 'http://localhost:3000/api/clients/assets/holdings?client_id=32&year=2025&month=5'
